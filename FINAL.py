...
def init_data():
    ...
    if not os.path.exists(TANKS_FILE):
        tanks = [
            ...
            {"fuel": "АИ-95", "number": 1, "max_volume": 20000, "current": 18000, "enabled": True},  # для колонок 1-4
            {"fuel": "АИ-95", "number": 2, "max_volume": 20000, "current": 1000,  "enabled": False}, # для колонок 5-8
